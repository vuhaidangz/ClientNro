...
public class Service
{
	...
	static long canChangeZone;

    public void requestChangeZone(int zoneId, int indexUI)
	{
		if (mSystem.currentTimeMillis() - canChangeZone >= 500L)
		{
            canChangeZone = mSystem.currentTimeMillis();
    ...
    static long currVuDangTrans;
    public void transportNow()
    {
		if (mSystem.currentTimeMillis() - currVuDangTrans >= 500L)
		{
			currVuDangTrans = mSystem.currentTimeMillis();
			Message message = null;
			try
			{
